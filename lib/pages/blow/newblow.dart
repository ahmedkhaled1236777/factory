...
class newblow extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    ...
    (
      ...
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text("blow-departement".tr(),style: TextStyle(fontFamily: apptexts.appfonfamily,fontSize: 20,fontWeight: FontWeight.bold),)
...
newblowrport(),          newshowblowreport(),
        ])
      ),
    );
  }
