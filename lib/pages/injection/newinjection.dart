...
import 'package:fac_app/pages/injection/newshowreport.dart';
...
class newinjection extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    ...
    (
      ...
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text("injection-departement".tr(),style: TextStyle(fontFamily: apptexts.appfonfamily,fontSize: 20,fontWeight: FontWeight.bold),)
