...
class showmaintenancereport extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    var prov=Provider.of<maintenceprovider>(context);
    return Scaffold(
      appBar:AppBar(title:Text("machine maintenance".tr(),style:TextStyle(fontSize: 18,fontWeight: FontWeight.bold) ),) ,
