...
class newwritemoldreport extends StatefulWidget{
  @override
  State<newwritemoldreport> createState() => newwritemoldreportstate();
}

class newwritemoldreportstate extends State<newwritemoldreport> {
  intialize()async{
 ...
 Provider.of<maintenceprovider>(context,listen: false).mold.clear();        Provider.of<maintenceprovider>(context,listen: false).stopreasons.clear();
        ...
        Provider.of<maintenceprovider>(context,listen: false).mold.clear();
  }
              ...
              datebutton(onpressed: (){
                ...
                dropdownbutton(hint:"choose shift".tr(),mo:Provider.of<shiftsprovider>(context).shift,onchanged: (val){
                  Provider.of<maintenceprovider>(context,listen: false).changedropshift(val);
                                ...
                                textform(con: prov.mold, valid:"mold error".tr(), hinttext: "mold".tr(),suffix:"",keyboardType: TextInputType.multiline,),
