...
import 'package:fac_app/pages/types/edittypesreports.dart';
...
class showtypesedits extends StatelessWidget{
  List<typemodel> data=[];
          ...
          children: [
             datebutton(onpressed: (){
                  ...
                  if(prov.date=="choose date"){showDialog(context: context, builder: ((context) {
                    return AlertDialog(title: Center(child: Text("please choose date".tr())),actions: [
