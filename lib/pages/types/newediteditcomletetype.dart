...
import 'package:fac_app/widgets/completeaddeditdialog.dart';
...
class newediteditcompletetypes extends StatelessWidget{
      ...
      children: [
           datebutton(onpressed: (){
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: dropdownbutton(onchanged:(val){                  Provider.of<completetypesprovider>(context,listen: false).changedroptypes(val);
...
,Row(
  ...
  children: [
        addbutton(type: "subtract".tr(),fontsize: 25,padding: 10,width: 100,height: 50,onpressed: ()async{
                           ...
                           else if( Provider.of<completetypesprovider>(context,listen: false).typename==null){
    ...
    return AlertDialog(
      ...
      actions: [
        Center(child: addbutton(type: "ok", height: 50, width: 70, onpressed:(){Navigator.pop(context);}, fontsize: 15, padding: 5))
          ...
          showDialog(context: context, builder: ((context) {
            return completeaddedittypesdialog(status: "subtract cat quantity".tr(), typename: prov.typename!, quantity:-int.parse(prov.edittypes.text), type: "حذف",packet:prov.editpacket.text,barcode: prov.con.text,sectionname: "complete types",edittypename: "edit complete types",);
          }))
        ;}
        }),
    ...
    return AlertDialog(
      ...
      showDialog(context: context, builder: ((context) {
            return completeaddedittypesdialog(status:"added category".tr(), typename: prov.typename!, quantity:int.parse(prov.edittypes.text), type: "اضافه",packet: prov.editpacket.text,barcode: prov.con.text,sectionname: "complete types",edittypename: "edit complete types",);
          }));
         }
        }),
