...
class subuserdialog extends StatelessWidget{
 ...
 prov.email.clear();
      ...
      Navigator.pop(context);
            ...
            Navigator.pop(context)    ;         }
             ...
             else {ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Wrong email".tr())));  
                 Navigator.pop(context)    ; }
