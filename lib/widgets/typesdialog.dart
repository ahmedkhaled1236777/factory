...
class showtypesdialog extends StatelessWidget{
final String status;
...
final String barcode;
  ...
  const showtypesdialog({super.key, required this.status, required this.typename, required this.quantity,required this.packet,required this.barcode});
  @override
...
actions: [
  ...
  Row(
    ...
    addbutton(type: "confirm", height: 50, width: 70, onpressed:()async{
      ...
      typesservice.setdata(production,"types")     ;
