...
class completeaddedittypesdialog extends StatelessWidget{
final String status;
...
final String edittypename;
  ...
  const completeaddedittypesdialog({super.key, required this.status, required this.edittypename,required this.sectionname,required this.typename, required this.quantity, required this.packet,required this.type,required this.barcode});
  @override
